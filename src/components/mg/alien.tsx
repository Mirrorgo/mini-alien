...
// Define the AlienParameters interface
type AlienParameters = Record<ParameterName, number>;
// Define props for the component
interface AlienParameterDisplayProps {
...
const Alien: React.FC<AlienParameterDisplayProps> = ({ parameters }) => {
  ...
  return (
    <div className="p-4 bg-black text-green-400 rounded-lg border border-green-500 font-mono">
      <div className="flex items-center justify-between mb-4">
        ...
        <div className="text-2xl">{getMoodEmoji(parameters.happiness)}</div>
      </div>
